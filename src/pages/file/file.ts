...
export class FilePage {
  ...
  url:any;
  si:any;
  constructor(public modalCtrl:ModalController,public navCtrl: NavController,public navParams: NavParams,public file:File,public httpstorage:HttpStorage,public alertCtrl:AlertController) {
    this.video=null;
    this.si=0;
